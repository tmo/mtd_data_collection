...
commit=" "
info="\nClient freq: 2s, Attacker frequency: no attacker\nAim: different file sizes\n Skip DNS "
...
sudo dumpcap -b filesize:200000000 -i "s1-eth2"  -w $home_dir/attacker_output/traces/trace_s1_eth2 -q &
