...
sudo docker cp ./mtd_apps/real_drop_cidr16_M60_onos-app-mtd-2.4.0.oar  onos_new:/root/onos/conts/mtd_drop_60.oar
...
sudo snort  -c /etc/snort/snort.conf -i s1-eth0 -h 10.0.0.100/16 -l $home_dir/defender_output/snort_output -A fast &
